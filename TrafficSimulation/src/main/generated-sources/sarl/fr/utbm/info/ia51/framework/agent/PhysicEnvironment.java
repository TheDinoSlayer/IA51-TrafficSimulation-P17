...
public interface PhysicEnvironment extends Capacity {
   ...
   */
  @DefaultValueSource
  public abstract void influenceKinematic(@DefaultValue("fr.utbm.info.ia51.framework.agent.PhysicEnvironment#INFLUENCEKINEMATIC_0") final Vector2f linearInfluence, @DefaultValue("fr.utbm.info.ia51.framework.agent.PhysicEnvironment#INFLUENCEKINEMATIC_1") final float angularInfluence, final Influence... otherInfluences);
   ...
   */
  @DefaultValueSource
  public abstract void influenceSteering(@DefaultValue("fr.utbm.info.ia51.framework.agent.PhysicEnvironment#INFLUENCESTEERING_0") final Vector2f linearInfluence, @DefaultValue("fr.utbm.info.ia51.framework.agent.PhysicEnvironment#INFLUENCESTEERING_1") final float angularInfluence, final Influence... otherInfluences);
   ...
   * @param otherInfluences other influences to emit in parallel to the motion influence.
   */
  @DefaultValueUse("fr.utbm.info.ia51.framework.math.Vector2f,float,fr.utbm.info.ia51.framework.environment.Influence*")
  @SyntheticMember
