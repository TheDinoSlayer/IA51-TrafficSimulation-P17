...
public class AbstractAnimat extends Agent {
  ...
  protected void emitInfluence(final MotionAlgorithmOutput output, final Influence... influences) {
    if ((output != null)) {
      ...
      if (_tripleEquals) {
        PhysicEnvironment _$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT$CALLER = this.$castSkill(PhysicEnvironment.class, (this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT == null || this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT.get() == null) ? (this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT = this.$getSkill(PhysicEnvironment.class)) : this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT);
        ...
        PhysicEnvironment _$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT$CALLER_1 = this.$castSkill(PhysicEnvironment.class, (this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT == null || this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT.get() == null) ? (this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT = this.$getSkill(PhysicEnvironment.class)) : this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT);
      ...
      PhysicEnvironment _$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT$CALLER_2 = this.$castSkill(PhysicEnvironment.class, (this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT == null || this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT.get() == null) ? (this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT = this.$getSkill(PhysicEnvironment.class)) : this.$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT);
  ...
  @SyntheticMember
  private transient ClearableReference<Skill> $CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT;
  
  @SyntheticMember
  @Pure
  @Inline(value = "$castSkill(PhysicEnvironment.class, ($0$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT == null || $0$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT.get() == null) ? ($0$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT = $0$getSkill(PhysicEnvironment.class)) : $0$CAPACITY_USE$FR_UTBM_INFO_IA51_FRAMEWORK_AGENT_PHYSICENVIRONMENT)", imported = PhysicEnvironment.class)
