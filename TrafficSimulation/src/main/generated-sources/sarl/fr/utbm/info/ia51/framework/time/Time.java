...
public interface Time extends Comparable<Time> {
   ...
   */
  @DefaultValueSource
  public abstract float getCurrentTime(@DefaultValue("fr.utbm.info.ia51.framework.time.Time#GETCURRENTTIME_0") final TimeUnit unit);
   ...
   */
  @DefaultValueSource
  public abstract float getLastStepDuration(@DefaultValue("fr.utbm.info.ia51.framework.time.Time#GETLASTSTEPDURATION_0") final TimeUnit unit);
