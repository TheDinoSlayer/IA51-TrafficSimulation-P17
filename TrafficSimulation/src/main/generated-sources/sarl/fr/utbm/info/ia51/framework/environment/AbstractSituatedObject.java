...
public abstract class AbstractSituatedObject implements SituatedObject, Serializable {
   ...
   */
  @DefaultValueSource
  public AbstractSituatedObject(final UUID id, final Shape2f<?> shape, @DefaultValue("fr.utbm.info.ia51.framework.environment.AbstractSituatedObject#NEW_0") final Point2f position) {
    this.id = id;
    this.shape = shape;
    if ((position != null)) {
   ...
   */
  @DefaultValueUse("java.util.UUID,fr.utbm.info.ia51.framework.math.Shape2f<?>,fr.utbm.info.ia51.framework.math.Point2f")
  @SyntheticMember
  ...
  @SyntheticMember
  private final static long serialVersionUID = 6243280831L;
}
