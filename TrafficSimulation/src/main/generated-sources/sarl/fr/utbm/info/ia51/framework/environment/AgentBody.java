...
public class AgentBody extends AbstractMobileObject implements Body {
   ...
   */
  @DefaultValueSource
  public void influenceKinematic(@DefaultValue("fr.utbm.info.ia51.framework.environment.AgentBody#INFLUENCEKINEMATIC_0") final Vector2f linearInfluence, @DefaultValue("fr.utbm.info.ia51.framework.environment.AgentBody#INFLUENCEKINEMATIC_1") final float angularInfluence) {
    Vector2f li = null;
   ...
   */
  @DefaultValueSource
  public void influenceSteering(@DefaultValue("fr.utbm.info.ia51.framework.environment.AgentBody#INFLUENCESTEERING_0") final Vector2f linearInfluence, @DefaultValue("fr.utbm.info.ia51.framework.environment.AgentBody#INFLUENCESTEERING_1") final float angularInfluence) {
    Vector2f li = null;
    if ((linearInfluence != null)) {
      li = linearInfluence.clone();
      float nSpeed = li.length();
  ...
  @SyntheticMember
  private final static long serialVersionUID = 2267916286L;
}
