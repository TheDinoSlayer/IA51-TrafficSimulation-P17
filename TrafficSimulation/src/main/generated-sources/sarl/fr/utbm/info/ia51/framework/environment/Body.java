...
public interface Body {
   ...
   */
  @DefaultValueSource
  public abstract void influenceKinematic(@DefaultValue("fr.utbm.info.ia51.framework.environment.Body#INFLUENCEKINEMATIC_0") final Vector2f linearInfluence, @DefaultValue("fr.utbm.info.ia51.framework.environment.Body#INFLUENCEKINEMATIC_1") final float angularInfluence);
   ...
   */
  @DefaultValueSource
  public abstract void influenceSteering(@DefaultValue("fr.utbm.info.ia51.framework.environment.Body#INFLUENCESTEERING_0") final Vector2f linearInfluence, @DefaultValue("fr.utbm.info.ia51.framework.environment.Body#INFLUENCESTEERING_1") final float angularInfluence);
