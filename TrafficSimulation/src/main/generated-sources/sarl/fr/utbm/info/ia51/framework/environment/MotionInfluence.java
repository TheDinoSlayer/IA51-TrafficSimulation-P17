...
public class MotionInfluence extends Influence {
   ...
   */
  @DefaultValueSource
  public MotionInfluence(final DynamicType type, @DefaultValue("fr.utbm.info.ia51.framework.environment.MotionInfluence#NEW_0") final UUID influencedObject, @DefaultValue("fr.utbm.info.ia51.framework.environment.MotionInfluence#NEW_1") final Vector2f linearInfluence, @DefaultValue("fr.utbm.info.ia51.framework.environment.MotionInfluence#NEW_2") final float angularInfluence) {
   ...
   */
  @DefaultValueUse("fr.utbm.info.ia51.framework.environment.DynamicType,java.util.UUID,fr.utbm.info.ia51.framework.math.Vector2f,float")
  @SyntheticMember
  ...
  @SyntheticMember
  private final static long serialVersionUID = 8292927520L;
}
