...
import fr.utbm.info.ia51.framework.time.Time;
...
public class TimePercept extends AbstractTime implements Serializable, Cloneable {
  ...
  @DefaultValueSource
  @Pure
  public float getCurrentTime(@DefaultValue("fr.utbm.info.ia51.framework.time.TimePercept#GETCURRENTTIME_0") final TimeUnit unit) {
  ...
  @DefaultValueSource
  @Pure
  public float getLastStepDuration(@DefaultValue("fr.utbm.info.ia51.framework.time.TimePercept#GETLASTSTEPDURATION_0") final TimeUnit unit) {
