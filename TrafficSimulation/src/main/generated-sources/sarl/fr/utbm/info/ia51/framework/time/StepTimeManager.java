...
import fr.utbm.info.ia51.framework.time.AbstractTime;
import fr.utbm.info.ia51.framework.time.AbstractTimeManager;
...
public class StepTimeManager extends AbstractTimeManager {
  ...
  @Override
  @Pure
  public synchronized float getCurrentTime(@DefaultValue("fr.utbm.info.ia51.framework.time.StepTimeManager#GETCURRENTTIME_0") final TimeUnit unit) {
  ...
  @Override
  @Pure
  public synchronized float getLastStepDuration(@DefaultValue("fr.utbm.info.ia51.framework.time.StepTimeManager#GETLASTSTEPDURATION_0") final TimeUnit unit) {
    TimeUnit _elvis = null;
    if (unit != null) {
      _elvis = unit;
    } else {
