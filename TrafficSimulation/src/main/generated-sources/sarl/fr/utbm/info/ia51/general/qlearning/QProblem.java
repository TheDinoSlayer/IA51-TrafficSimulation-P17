...
public interface QProblem<S extends QState, A extends QAction> extends Cloneable, Serializable {
   ...
   */
  public abstract QProblem<S, A> clone();
   ...
   */
  public abstract List<S> getAvailableStates();
   ...
   */
  public abstract List<A> getAvailableActionsFor(final S state);
   ...
   * @return the feedback
   */
  public abstract QFeedback<S> takeAction(final S state, final A action);
}
