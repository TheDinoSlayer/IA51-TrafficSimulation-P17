...
public class BusBody extends AgentBody {
  @Override
  @Pure
  @SyntheticMember
  public BusBody clone() {
    try {
      return (BusBody) super.clone();
   ...
   */
  @SyntheticMember
  public BusBody(final UUID id, final Shape2f<?> shape, final float maxLinearSpeed, final float maxLinearAcceleration, final float maxAngularSpeed, final float maxAngularAcceleration, final Frustum frustum) {
